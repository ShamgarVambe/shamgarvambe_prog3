...
public class Task {
   ...
   public void deleteTask(String[] taskNames, String[] taskDevelopers, int[] taskDurations, String[] taskStatus, String taskToDelete) {//this code deletes a task from the system
